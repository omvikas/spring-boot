...
@Entity
@Table(name="received_monitor")
public class ReceivedMonitor {
	
	private int received_monitor_id;	 	 	 	 	 	 	
	private String name;		 	 	 	 	 	 	
	private int patient_visit_id;		 	 	 	 	 	 	
	private int visit_monitor_id;		 	 	 	 	 	 	
	...
	@Id
	@GeneratedValue
	@Column(name="received_monitor_id")
	public int getReceived_monitor_id() {
		return received_monitor_id;
	}
	public void setReceived_monitor_id(int received_monitor_id) {
		this.received_monitor_id = received_monitor_id;
	}
	...
	@Column(name="visit_monitor_id")
	public int getVisit_monitor_id() {
		return visit_monitor_id;
	}
	public void setVisit_monitor_id(int visit_monitor_id) {
		this.visit_monitor_id = visit_monitor_id;
	}
